inherited fFormSetPound: TfFormSetPound
  Caption = #35774#32622#30917#31449
  ...
  object PanelMain: TUnimContainerPanel
    ...
    object DBGrid1: TUnimDBGrid
      ...
      Columns = <
        ...
        item
          Title.Caption = #30917#31449#32534#21495
          FieldName = 'T_FixPound'
          Width = 150
        end>
    end
    object PanelBottom: TUnimContainerPanel
      ...
      object BtnSortPound: TUnimButton
        Left = 110
        Top = 0
        Width = 110
        Height = 35
        ...
        ParentShowHint = False
        Align = alLeft
        Caption = #25353#30917#31449#25490#24207
        IconCls = 'locate'
        UI = 'action'
        OnClick = BtnSortPoundClick
      end
